 ...
 *
 * <ul>
 * <li><b>inventory</b> – list of items currently held.</li>
 * <li><b>weapon</b> – optional equipped [[Weapon]].</li>
 * <li><b>equipWeapon</b> – returns a new instance with the weapon set.</li>
 * <li><b>addItem</b> – adds an item to the inventory.</li>
 * <li><b>getItem</b> – finds an item by (trimmed, case-insensitive) name.</li>
 * <li><b>removeItem</b> – deletes an item from the inventory.</li>
 * </ul>
 *
 * @tparam E concrete entity type that mixes in <code>Inventory</code>
 */
