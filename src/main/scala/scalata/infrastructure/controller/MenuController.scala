...
/** Controller for the **main menu**.
  *
  * <ul> <li>Calls [[GameStartUseCase]] to ask the player if a new run should
  * begin.</li> <li>Returns the next [[GameControllerState]] together with the
  * updated [[GameBuilder]].</li> </ul>
  *
  * @param askStart
  *   effect that yields <b>true</b> to start or <b>false</b> to quit
  */
