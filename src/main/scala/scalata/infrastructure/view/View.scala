...
/** Generic view helper.
  *
  * <ul> <li><b>banner</b> – value shown before asking.</li> <li><b>parse</b> –
  * turns raw input into a domain object.</li> <li><b>ask</b> – prints banner,
  * then delegates to a loop that re-prompts via <code>Shared.run</code> until
  * parsing succeeds.</li> </ul>
  */
