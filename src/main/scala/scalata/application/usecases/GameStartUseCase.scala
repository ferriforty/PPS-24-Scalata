...
/** Use-case that handles the “Start Game?” choice shown in the main menu.
  *
  * <p> • **true** → transition to <code>GameControllerState.ChampSelect</code>
  * • **false** → return a <code>GameError.GameOver</code> </p>
  */
class GameStartUseCase:
  ...
  /** Evaluate the player’s answer and emit the next step.
    *
    * @param input
    *   side-effecting Boolean (<b>true</b>=start, <b>false</b>=quit)
    * @param worldBuilder
