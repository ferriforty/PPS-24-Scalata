 ...
 * <h4>Capabilities</h4>
 * <ul>
 * <li><b>`create`</b> – build a concrete enemy from an [[EnemyClasses]] tag.</li>
 * <li><b>`randomGeneration`</b> – convenience helper that picks a random
 * enemy family and delegates to <code>create</code>.</li>
 * </ul>
 *
...
class EnemyFactory extends EntityFactory[EnemyFactory, Enemy, EnemyClasses]:
   ...
   *
   * @param id unique identifier to assign to the new enemy
   * @return freshly-constructed [[Enemy]]
   */
   ...
   *
   * @param entityType discriminator selecting Goblin / Pig
