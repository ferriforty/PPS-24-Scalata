...
/** Immutable builder that assembles a complete [[GameSession]].
  *
  * <h4>Parameters</h4> <ul> <li><b>player</b> optional hero to start the run
  * with; must be supplied before calling [[build]].</li> <li><b>difficulty</b>
  * global difficulty level (1–10).</li> <li><b>level</b> tower floor to
  * generate (starts at <code>1</code>).</li> </ul>
  *
