...
/** Generic <i>factory type-class</i> able to build domain entities.
  *
  * <h4>Type parameters</h4> <ul> <li><b>F</b> – concrete factory that
  * implements the trait (self-type used for fluent APIs).</li> <li><b>E</b> –
  * entity returned by the factory (e.g.&nbsp;<code>Enemy</code>,
  * <code>Item</code>).</li> <li><b>P</b> – descriptor specifying which concrete
  * subtype to create (enum, string tag, config object …).</li> </ul>
  *
